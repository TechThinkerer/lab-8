...
namespace Customer_Preview
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (Server = AUMC - LAB3 - 06\\SQLEXPRESS; Database = customerdb; Trusted_Connection = True connection = new "Server=AUMC-LAB3-06\\SQLEXPRESS;Database=customerdb;Trusted_Connection=True;"; (connectionString))
        {
                connection.Open();
                string query = "INSERT INTO YourTableName (Name, Country, Gender, Hobby, Status) VALUES (@Name, @Country, @Gender, @Hobby, @Status)";
                using (dataGridView1 command = new dataGridView1(query, connection))
                {
